    ...
    App::new()
        ...
        .add_systems(Update, 
            (
                ...
                (gravity, detect_lock_position, lock_in_tetromino, move_tetromino, detect_bag_low, check_for_lines, update_gravity_timer, maybe_lock_in_tetromino, detect_kick_back_to_red_zone),
