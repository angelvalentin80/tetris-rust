...
use crate::game_manager::{GameStartEvent, detect_start_game, detect_restart_game, GameRestartEvent, GameLoseEvent};
    ...
    App::new()
        ...
        .add_systems(Update, 
            (
                ...
                (gravity, lock_in_tetromino, move_tetromino, detect_lock_position, detect_bag_low, check_for_lines, update_gravity_timer, detect_lose_conditions),
                (restart_queue, detect_restart_game, despawn_active_tetromino, reset_grid, despawn_next_piece, reset_level_and_score, reset_lock_in_timer, reset_gravity_timer)
            ))
        .run();
}
